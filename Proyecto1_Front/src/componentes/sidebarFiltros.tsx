...
export function SidebarFiltros({ isOpen, onClose, onOpen }: Omit<SidebarProps, "filtrosNecesarios">) {
  ...
  const { lineas, sublineas, marcas, clientes, proveedores, condicionesIva, provincias, familiasBanco, superlineas } =
    useCatalogosContext();
              ...
              <div className="flex-1 min-h-0 overflow-y-auto">
                <div className="p-4 space-y-4">
                  <Accordion type="multiple" className="w-full space-y-2">
                    ...
                    {/* Filtro SuperLínea — CR-004 (CA-004.3) */}
                      ...
                      <AccordionItem value="superlinea" className="border border-gray-200 dark:border-slate-600 rounded-lg">
                        ...
                        <AccordionContent className="px-4 pb-4">
                          <div className="border-t border-gray-100 dark:border-slate-700 pt-4">
                            <div className="bg-gray-50 dark:bg-slate-700 rounded-lg p-4 border border-gray-200 dark:border-slate-600">
                              <div className="space-y-3">
                                {/* Input de búsqueda por denominación */}
                                <div className="relative">
                                  <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
                                  <Input
                                    type="text"
                                ...
                                {/* Select de SuperLínea
                                    TODO CR-003: Cuando CR-003 esté integrado, poblar 'superlineas'
                                    desde el endpoint de SuperLíneas en consultar-producto.tsx */}
                                <div>
                                  <Select
                                    value={
